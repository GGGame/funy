...
var SysMenu = cc.Layer.extend({
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            var _this = this.init, that = this;
            var newGame = cc.MenuItemSprite.create(newGameNormal, newGameSelected, newGameDisabled, function () {
                cc.log('--------------------');
                that.onButtonEffect();
                cc.log('++++++++++++++++');
                flareEffect(that, _this, that.onNewGame);
            });
            var gameSettings = cc.MenuItemSprite.create(gameSettingsNormal, gameSettingsSelected, gameSettingsDisabled, this.onSettings);
            var about = cc.MenuItemSprite.create(aboutNormal, aboutSelected, aboutDisabled, this.onAbout);
